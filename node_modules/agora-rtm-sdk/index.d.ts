...
interface SendMessageOptions {
   ...
   */
  /**
   * @deprecated This method is deprecated. Agora recommends that you do not use it.
   * 
...
declare namespace RtmEvents {
  ...
  export interface RtmClientEvents {
    ...
    /** @zh-cn
     * SDK 自动回退至 WebSocket 443 端口回调。
     * 
     * 当防火墙导致边缘节点不可用时，SDK 自动启用云代理切换端口，并返回此回调通知本次回退。
     * 
     */
    /**
     * Occurs when the SDK automatically falls back to WebSocket port 443.
     * 
     * When the SDK automatically enables Cloud Proxy to accommodate the firewall settings of an end user, this callback is triggered to notify the end user about this fallback.
     */
